🧮 Tip Calculator | Day Challenge

A simple and interactive Tip Calculator that helps users quickly calculate the tip amount and total bill per person. This project is perfect for practicing JavaScript DOM manipulation, responsive UI, and real-world UI/UX logic.
